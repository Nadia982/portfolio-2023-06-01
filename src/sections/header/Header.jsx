  ...
  return (
    <section id="header">
      <div className="container header__container">
        ...
        <p>I am based in <strong>London, UK</strong> and have been building websites with React and JavaScript since 2022.</p> 
      <p>As at June 2023, I am <strong>open</strong> to new work opportunities. </p>
      ...
      <p>If you would like to get in touch then please:</p> 
      <div className="header__cta">   
      <a href="https://www.linkedin.com/in/natalie-g-b947331a/" className="btn primary">Message me on LinkedIn</a>
      </div>
      <p>Click on the icons below to see my skills and experience in the following technologies:</p>
      </div>
