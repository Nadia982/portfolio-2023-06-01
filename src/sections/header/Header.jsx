  ...
  return (
    <header id="header">
      <div className="container header__container">
        ...
        <p>I am based in <strong>London, UK</strong> and have been building websites with <strong>React and JavaScript</strong> since 2022. As at June 2023, I am <strong>open to new work</strong> opportunities. If you would like to get in touch then please:</p> 
